...
3) Вывести XML-файл, содержащий все текстовые записи на русском языке (атрибут "rus"). Необходимо также учитывать, что данный атрибут может содержать не только тег, содержащий текст, но и любой из его предков.
